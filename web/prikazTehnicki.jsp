<%-- 
    Document   : prikazTehnicki
    Created on : 26.08.2022., 02.41.16
    Author     : Ognjen
--%>
...
<div class="container" >   
            <div id="naslov">
                <h1>Tehnicki pregledi</h1>
                <p>Spisak tehnickih</p>
            </div>
            <% 
...
<table class="table">
  <thead class="thead-dark">
   ...
   <% for(Tehnicki t : tehnicki){
    ...
    <tr>
      <th scope="row"><%=i%></th>
      <td><a href="PrikazTehnickog?naziv=<%=t.getNaziv()%>"><%=t.getNaziv()%> </a></td>
      <td><%=t.getLokacija()%></td>
      <td><%=t.getRadnoVreme()%></td>
      <td><%=t.getKontakt()%></td>
      <td><a href="PrikazTermina?idTehnicki=<%=t.getIdTehnicki()%>"><input type="button" value="Rezervisi termin"></a></td>
      <td></td>
    </tr>
        <% } %>
      </tbody>
