<%-- 
    Document   : index
    Created on : 08.11.2021., 15.08.54
    Author     : Ognjen
--%>
...
<html>
  ...
  <div class="jumbotron">
    <div class="container">
      ...
      <p><a class="btn btn-primary btn-lg" href="AgencijeServlet" role="button">Pogledaj vise »</a></p>
    </div>
  </div>
  ...
  <div class="container" >
    ...
    <div class="row">
      <div class="col-md-4">
        ...
        <img src="img/agencija1.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Pregled Agencija</h5>
              <p class="card-text">Pogledajte lokacije svih nasih agencija kao i informacije o njima.</p>
              <a href="AgencijeServlet" class="btn btn-primary">Prikaz agencija</a>
            </div>
        </div>  
     </div>
      <div class="col-md-4">
        <div class="card" style="width: 18rem;">
        <img src="img/tehnicki.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Tehnički</h5>
              <p class="card-text">Pogledajte lokacije tehničkih kao i informacije o njima.</p>
              <a href="PrikazTehnicki" class="btn btn-primary">Prikaz Tehničkih</a>
            </div>
        </div>
      </div>
      <div class="col-md-4" >
        ...
        <img src="img/auto.jpg" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Kalkulator registracije</h5>
              <p class="card-text">Izracunajte cene registracije brzo i lako</p>
              <a href="kalkulator.jsp" class="btn btn-primary">Pretrazite</a>
            </div>
        </div>
    </div>
