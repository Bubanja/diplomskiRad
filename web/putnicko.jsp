...
<html>
 ...
 <div id="content"  class="col-md-6 offset-md-3">  
                <form method="POST" action="KalkulacijaPutnickoServlet">
                    <table class="table">
                        <thead class="thead-dark">
                        <tr>
                             <th>Tip vozila</th>
                             <td><input type="text" name="tip" readonly="true" value="putnicko"></td>
                            </tr>
                        </thead>
                        <tbody class="thead-dark">
                         <tr> 
                             <th>Godiste</th>
                             <td><input type="text" name="godiste" value="" required></td>
                         </tr>
                         <tr>
                             <th>Zapremina</th>
                             <td><input type="text" name="zapremina" value="" required>ccm</td>
                         </tr>
                         <tr>
                             <th>Snaga</th>
                             <td><input type="text" name="snaga" value="" required>KW</td>
                         </tr>
                         <tr>
                             <th>Premijski stepen</th>
                             <td><select selected="4" id="stepen" name="stepen">
                             ...
                             <tr>
                             <th>Nova saobracajna</th>
                             <td><input type="checkbox" name="saob" value="saob"></td>
                         </tr>
                         <tr>
                             <th>Nove registarske tablice</th>
                             <td><input type="checkbox" name="tablice" value="tablice"></td>
                         </tr> 
                         <tr>
                             <th>Tehnički</th>
                             <td><input type="checkbox" name="tehnicki" value="tehnicki"></td>
                         </tr>
                         <tr>
                             <td><input type="submit" value="Izracunaj" /></td>
                         </tr>
                         <p>Cena tehničkog pregleda iznosi 5000 dinara!!!</p>
                    </tbody>
                    </table>
                </form>
            </div>
