    ...
    <div class="row">
      <div class="col-md-12" center>
        <div class="card" style="width: 72rem;">
            <div class="card-body">
              <h5 class="card-title">Zeleni karton - Zelena karta:</h5>
              <p class="card-text">Zeleni karton predstavlja zamenu za polisu osiguranja koju koristite u Srbiji kada ste u inostranstvu.</br></br>
Zelena karta predstavlja dokaz da je vaše vozilo osigurano kod nekog domaćeg osiguravajućeg društva</br></br>
Zeleni karton izdaje ista kuća sa kojom ste sklopili obavezno osiguranje vozila od autoodgovornosti.</br></br>
Važnost zelene karte počinje na dan izdavanja i traje do isteka polise auto odgovornosti.</br></br>
Da bi ste izvadili zeleni karton potrebno je da priložite polisu obaveznog osiguranja i saobraćajnu dozvolu na uvid.</br></br>
Zelena karta je potrebna za Makedoniju i Republiku Srpsku i prilikom ulaska u te zemlje tražiće Vam na uvid.</br></br>
               </p>
            </div>
        </div>  
     </div>
