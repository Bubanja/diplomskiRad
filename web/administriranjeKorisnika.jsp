            ...
            <table class="table">
                ...
                %>              
                    <tr>
                        ...
                        <td><%=k.getTip()%></td>
                        <td><%=k.getEmail()%></td>
                        <td colspan="2"><a href="IzmenaKorisnikaAdminServlet?id=<%=k.getId()%>"><input type="button" value="Izmeni"></td>
                                <td> <a href="ObrisiKorisnikaAdminServlet?id=<%=k.getId()%>"><input type="button" value="Obrisi"></a></td>
                    </tr>
                <% }} %>
                </tbody>
            </table>
