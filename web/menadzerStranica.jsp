...
<table class="table">
  <thead class="thead-dark">
      <tr>
            <th colspan="4" align="center">Menadzer stranica</th>
      </tr>
</thead>
<tbody>
    <tr>
        <th>1</th>
        <td>Pregled aktivnih rezervacija termina:</td>
        <td></td>
        <td><a href="AktivneRezervacijeMenadzerServlet">Podaci o rezervacijama</a>&nbsp&nbsp</td>
    </tr>
    <tr>
        <th>2</th>
        <td>Pregled aktivnih korisnika: </td>
        <td></td>
        <td> <a href="AktivniKorisniciServlet">Podaci o korisnicima</a>&nbsp&nbsp</td>
    </tr>
     <tr>
        <th>3</th>
        <td>Pregled aktivnih slepovanja: </td>
        <td></td>
        <td> <a href="AktivnoSlepovanjeServlet">Podaci za slep</a>&nbsp&nbsp</td>
    </tr>
    <tr>
        <th>4</th>
        <td>Slep vozila: </td>
        <td> <a href="dodajVoziloMenadzer.jsp">Dodaj novo slep vozilo</a>&nbsp&nbsp</td>
        <td> <a href="MenadzerVozilaServlet">Obrisi/Izmeni slep vozilo</a>&nbsp&nbsp</td>
    </tr>
</tbody>
