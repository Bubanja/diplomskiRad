...
<html>
 ...
 <div id="content"  class="col-md-6 offset-md-3">  
                <form method="POST" action="KalkulacijaTeretnoServlet">
                    <table class="table">
                        <thead class="thead-dark">
                        <tr>
                             <th>Tip vozila</th>
                             <td><input type="text" name="tip" readonly="true" value="teretno"></td>
                            </tr>
                        </thead>
                        <tbody class="thead-dark">
                         ...
                         <tr>
                             <th>Nosivost(kg)</th>
                             <td><input type="text" name="nosivost" value="" required>kg</td>
                         </tr>
                         <tr>
                         ...
                         <p>Cena tehničkog pregleda iznosi 7000 dinara!!!</p>
                    </tbody>
                    </table>
                </form>
            </div>
