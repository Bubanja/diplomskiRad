...
<html lang="en">
    ...
    <body >   
        ...
        <div class="container" >   
            <div id="naslov">
                <h1>Izmena agencije</h1>
            </div>  
            <%
                Agencija a = (Agencija)request.getAttribute("agencija");              
            %>
           <form method="post" action="PotvrdiIzmeneAgencijaServlet" >
                            <label for="naziv" >Naziv:</label>
                            <input type="text" name="naziv" value="<%=a.getNaziv()%>"> <br><br>

                            <label for="radnoVreme">Radno vreme:</label>
                            <input type="text" name="radnoVreme" value="<%=a.getRadnoVreme()%>"> <br><br>

                            <label for="lokacija">Lokacija:</label>
                            <input type="text" name="lokacija" value="<%=a.getLokacija()%>"> <br><br> <br><br>

                            <label for="kontakt">Kontakt:</label>
                            <input type="text" name="kontakt" value="<%=a.getKontakt()%>"> <br><br>
                            
                            <label for="slika">Slika:</label>
                            <input type="text" name="slika" value="<%=a.getSlika()%>"> <br><br> 
                            
                              <input type="hidden" name="id" value="<%=a.getIdAgencija()%>">
