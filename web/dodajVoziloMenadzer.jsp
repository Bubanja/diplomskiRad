...
<div class="content">
            <div class="reg">
                <h2>Dodavanje novog šlep vozila</h2>
                    <div class="forma">
                        <form method="post" action="DodajVoziloMenadzerServlet">
                            <label for="naziv">Nosivost: </label>
                            <input type="text" name="nosivost"> <br><br>

                            <label for="radnoVreme">Cena po km:</label>
                            <input type="text" name="cena">din<br><br>
