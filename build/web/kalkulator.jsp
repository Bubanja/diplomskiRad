<%-- 
    Document   : kalkulator
    Created on : 09.11.2021., 14.32.35
    Author     : Ognjen
--%>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h5 class="card-title">Kalkulator registracije za putnicka vozila</h5>
              <p class="card-text">Izracunajte cenu registracije putnickog vozila.</p>
              <a href="putnicko.jsp" class="btn btn-primary">Prikaz</a>
            </div>
        </div>  
     </div>
      <div class="col-md-6">
        <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h5 class="card-title">Kalkulator registracije za teretna vozila</h5>
              <p class="card-text">Izracunajte cenu registracije teretnog vozila.</p>
              <a href="teretno.jsp" class="btn btn-primary">Prikaz</a>
            </div>
        </div>
      </div>
</div> <!--/container -->
