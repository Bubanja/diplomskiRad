<%-- 
    ...
    Created on : 29.09.2022., 12.49.12
    Author     : Ognjen
--%>
...
<html>
  ...
  <div class="jumbotron">
    <div class="container">
      ...
      <p><a class="btn btn-primary btn-lg" href="BioskopiServlet" role="button">Pogledaj vise »</a></p>
    </div>
  </div>
      ...
      <div class="col-md-4">
        ...
        <img src="..." class="card-img-top" alt="...">
            <div class="card-body">
              ...
              <a href="#" class="btn btn-primary">Pretrazite</a>
            </div>
        </div>  
     </div>
      <div class="col-md-4">
      ...
      <div class="col-md-4" >
        ...
        <img src="..." class="card-img-top" alt="...">
            <div class="card-body">
              ...
              <p class="card-text">Posetite nas na nasim lokacijama</p>
              <a href="#" class="btn btn-primary">Pretrazite</a>
            </div>
        </div>
    </div>
