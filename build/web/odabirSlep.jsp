    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark" center>
            ...
            <span class="navbar-text" style="color:white"><b>AGENCIJA AUTO SONG</b></span>
                ...
                <div class="jumbotron">
    <div class="container">
      <h1 class="display-3">Rezervacija šlep vozila</h1>
      <p>Dobrodosli u agenciju AUTO SONG, rezervišite šlep vozilo</p>
    </div>
  </div>
        <div class="container">
        <h2 id="msg">  
    ...
    <tr>
      ...
      <td><%=s.getKontakt()%></td>
       <%
                if(korisnik != null){
            %>
      <td><a href="FormaZaSlep?idSlep=<%=s.getIdSlep()%>"><input type="button" value="Rezervisi"></a></td>
      <%
                }else{
            %>
       <td><a href="login.jsp"><input type="button" value="Rezervisi"></a></td>
    </tr>
        <% } 
}
        %>
