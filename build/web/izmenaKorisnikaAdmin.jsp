...
<html lang="en">
    ...
    <body >   
        ...
        <div class="container" >   
            <div >
                <h1>Izmena korisnika u bazi podataka</h1>
            </div>  
            <div id="content">
            <%
                Korisnik k = (Korisnik)request.getAttribute("korisnik");
            %>
            <form method="POST" action="PotvrdiIzmeneKorisnikaAdminServlet">
                <table class="table" >
                    ...
                    <tbody>
                     <tr>                           
                         <td><input type="password" name="password" value="<%=k.getPassword()%>"></td>
                         <td><input type="text" name="ime" value="<%=k.getIme()%>"></td>    
                         <td><input type="text" name="prezime" value="<%=k.getPrezime()%>"></td>
                         <td><input type="date" name="datum" value="<%=k.getDatum()%>"></td>
                         <td><input type="text" name="pol" value="<%=k.getPol()%>"></td>
                         <td><input type="email" name="email" value="<%=k.getEmail()%>"></td>
