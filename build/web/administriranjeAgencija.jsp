...
<div class="container">  
            <div id="agencije">
                <h1>Administriranje agencija</h1>
            </div>                              
            <div id="content">  
               ...
               <table style="width:80%">
                    ...
                    <tr>
                        <td>
                            <a href="PrikazAgencija?naziv=<%=a.getNaziv()%>"><img src="<%=a.getSlika()%>" style=' width:200px; height: 200px; ' ></a>
                        </td>
                        <td>
                            <a href="PrikazAgencija?naziv=<%=a.getNaziv()%>"> <%=a.getNaziv()%>  </a>
                        </td>
                        <td colspan="2"><a href="IzmeniAgencijuAdminServlet?id=<%=a.getIdAgencija()%>"><input type="button" value="Izmeni">
                                <a href="ObrisiAgencijuAdminServlet?id=<%=a.getIdAgencija()%>"><input type="button" value="Obrisi"></a></td>
                    </tr>
                    <% } %>
              </table>
            </div>
