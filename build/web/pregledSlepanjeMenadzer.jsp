...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    ...
    <p class="lead">Pregled svih rezervacija</p>
  </div>
</div>                  
                        <%
                 ArrayList<Slepanje> rezervacije = (ArrayList<Slepanje>)request.getAttribute("rezervacije");
             %>
             <table class="table">
             ...
             <tbody>
                <% for(Slepanje r : rezervacije){
                %> 
                <tr>
                    <td><%=r.getIdSlepanje()%></td>
                    <td><%=r.getIdSlep()%></td>
                    <td><%=r.getIdKorisnik()%></td>
                    <td><%=r.getImePrezime()%></td>
                    <td><%=r.getVreme()%></td>
                    <td><%=r.getKontakt()%></td>
                    <td><%=r.getLokacija()%></td>
                    <td> <a href="ObrisiSlepanjeServlet?id=<%=r.getIdSlepanje()%>&idSlep=<%=r.getIdSlep()%>"><input type="button" value="Obrisi"></a></td>
                </tr>
                <% } %>
             </tbody>
            </table>
