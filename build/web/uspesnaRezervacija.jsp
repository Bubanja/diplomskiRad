...
<html>
  ...
  <% int idRezervacije = (int)request.getAttribute("idRezervacije"); %>
        ...
        <div class="container">
            <h1 class="display-4">Agencija AUTO Song</h1>
            <p class="lead">Uspesno ste rezervisali termin za tehnički pregled, molimo vas da dodjete najkasnije 15 min. pre pocetka tehničkog!
                Vas ID rezervacije je : <big style="color:red"> <%=idRezervacije%></big> .Molimo vas da sacuvate ovaj ID rezervacije i pokazete zaposlenima.</p>
        </div>
        </div> 
        </div>
</main>
