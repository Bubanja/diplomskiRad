...
<html>
  ...
  <% int idSlepanje = (int)request.getAttribute("idSlepanje"); %>
        <div class="container">  
        <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">Agencija AUTO Song</h1>
            <p class="lead">Uspesno ste rezervisali slepanje vozila!
                Vas ID rezervacije je : <big style="color:red"> <%=idSlepanje%></big> .Molimo vas da sacuvate ovaj ID rezervacije i pokazete zaposlenima.</p>
        </div>
        </div> 
        </div>
</main>
