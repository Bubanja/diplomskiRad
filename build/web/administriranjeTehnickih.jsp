...
<html lang="en">
    <head>
        ...
        <title>Tehnički pregledi - admin</title>
...
<div class="container">  
            <div id="agencije">
                <h1>Administriranje tehničkih</h1>
            </div>                              
            <div id="content">  
                
               <table style="width:80%">
                    <% ArrayList<Tehnicki> tehnicki = (ArrayList<Tehnicki>)request.getAttribute("tehnicki"); 
                    for(Tehnicki t : tehnicki){
                    %>
                    <tr>
                        <td>
                            <a href="PrikazTehnickog?naziv=<%=t.getNaziv()%>"><img src="<%=t.getSlika()%>" style=' width:200px; height: 200px; ' ></a>
                        </td>
                        <td>
                            <a href="PrikazTehnickog?naziv=<%=t.getNaziv()%>"> <%=t.getNaziv()%>  </a>
                        </td>
                        <td colspan="2"><a href="IzmeniTehnickiAdminServlet?id=<%=t.getIdTehnicki()%>"><input type="button" value="Izmeni">
                                <a href="ObrisiTehnickiAdminServlet?id=<%=t.getIdTehnicki()%>"><input type="button" value="Obrisi"></a></td>
                    </tr>
                    <% } %>
              </table>
            </div>
