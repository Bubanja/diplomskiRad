...
<html>
 ...
 <!-- Main jumbotron for a primary marketing message or call to action -->
  ...
  <% int konacno =  (int)request.getAttribute("konacno");
     int takse =  (int)request.getAttribute("takse");
  %>
  <div class="container" >
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h5 class="card-title">Konacna cena registracije iznosi:</h5>
              <p class="card-text"><%=konacno %></p>
      ...
      <div class="col-md-6">
        <div class="card" style="width: 18rem;">
            <div class="card-body">
              <h5 class="card-title">Konacne takse registracije iznosi:</h5>
              <p class="card-text"><%=takse %></p>
            </div>
        </div>
      </div>
</div> <!--/container -->
