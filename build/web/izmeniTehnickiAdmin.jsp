...
<html lang="en">
    ...
    <body >   
        ...
        <div class="container" >   
            <div id="naslov">
                <h1>Izmeni tehnički pregled</h1>
            </div>  
            <%
                Tehnicki t = (Tehnicki)request.getAttribute("tehnicki");              
            %>
           <form method="post" action="PotvrdiIzmeneTehnickiServlet">
                            <label for="naziv">Naziv:</label>
                            <input type="text" name="naziv" value="<%=t.getNaziv()%>"> <br><br>

                            <label for="radnoVreme">Radno vreme:</label>
                            <input type="text" name="radnoVreme" value="<%=t.getRadnoVreme()%>"> <br><br>

                            <label for="lokacija">Lokacija:</label>
                            <input type="text" name="lokacija" value="<%=t.getLokacija()%>"> <br><br> <br><br>

                            <label for="kontakt">Kontakt:</label>
                            <input type="text" name="kontakt" value="<%=t.getKontakt()%>"> <br><br>
                            
                            <label for="slika">Slika:</label>
                            <input type="text" name="slika" value="<%=t.getSlika()%>"> <br><br> 
                            
                              <input type="hidden" name="id" value="<%=t.getIdTehnicki()%>">
