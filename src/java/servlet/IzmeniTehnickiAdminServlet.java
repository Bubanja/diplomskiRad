 ...
 * @author Bubanja
 */
public class IzmeniTehnickiAdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {                    
            ...
            String upit = "SELECT * FROM tehnicki WHERE idTehnicki='"+id+"';";
            ...
            if(rs.next()){
                ...
                request.getRequestDispatcher("izmeniTehnickiAdmin.jsp").forward(request, response);  
            }else{
